...
**Single striking statistics illustrated as visual data points using Klaus aesthetic and the 2-style organic system.**

Creates **ILLUSTRATED STAT CARDS** — one number/statistic made visual using Sumi-e Ink or Blended Hand-Drawn styles with HIGH negative space (ma 間).
...
## Visual Aesthetic: 2-Style Organic System for Stats

**Recommended styles:** Sumi-e Ink (primary) or Blended Hand-Drawn

### Style Selection

**Ligne Claire (For clean, punchy stats):**
- Crisp number typography
- Clean icon illustration
- Flat colors for clarity
- HIGH NEGATIVE SPACE (50-60%)

**Watercolor (For softer, emotional stats):**
- Number with subtle wash background
- Gentle illustration accents
- Soft edges create atmosphere
- HIGH NEGATIVE SPACE (50-60%)
...
3. **Small illustration** — Style-appropriate visual showing what stat represents
...
### Number Typography
```
Lawn Green #7CFC00 — Primary number (most common)
OR
Maastricht Blue #002233 — Alternative bold number
```

### Illustration
```
Maastricht Blue #002233 — Small illustration linework
Lawn Green #7CFC00 — Accents on illustration
Tea Green #D7FEB2 — Alternative accents
```

### Background
```
Honey Dew #F6FFED — Warm neutral
OR
...
BACKGROUND: [Honey Dew #F6FFED / White #FFFFFF] — flat, clean
...
- Color: [Lawn Green #7CFC00 / Maastricht Blue #002233]
...
- Hand-drawn black (#002233) linework
- Purple (#7CFC00) accents on [specific elements]
...
COLOR USAGE:
- Number: Deep Purple (#7CFC00) OR Black (#002233)
- Illustration linework: Black (#002233)
- Illustration accents: Purple (#7CFC00) OR Teal (#D7FEB2)
- Metric/context text: Charcoal (#2D2D2D)
- Background: Light Cream (#F6FFED) OR White (#FFFFFF)
