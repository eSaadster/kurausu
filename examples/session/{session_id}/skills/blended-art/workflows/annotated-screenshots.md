...
**Real screenshots with editorial annotations, arrows, and highlights using Klaus aesthetic and the 2-style organic system.**

Creates **ANNOTATED SCREENSHOTS** — actual UI screenshots or code snippets with Blended Hand-Drawn style commentary overlays.
...
## Visual Aesthetic: Real + Ligne Claire Overlay

**Recommended style:** Ligne Claire (clean, uniform annotations)

### Style Approach

**Ligne Claire for annotations:**
- Strong, uniform line weight for arrows and circles
- Flat color fills for callout boxes
- Clean, architectural precision
- Clear, professional appearance

### Core Characteristics
1. **Real foundation** — Actual screenshot or code snippet (not illustrated)
2. **Ligne Claire overlay** — Clean arrows, circles, highlights, callouts
3. **Typography mix** — Real UI text + clear annotations
4. **Color accents** — Lawn Green/Tea Green for annotations against real screenshot
5. **Functional clarity** — Annotations enhance understanding, not just decoration
6. **UL aesthetic** — Maintains brand colors with Ligne Claire precision
7. **Professional quality** — Clean enough for client deliverables
...
### Annotation Overlay
```
Lawn Green #7CFC00 — Primary annotations (important callouts)
Tea Green #D7FEB2 — Secondary annotations (supporting notes)
Maastricht Blue #002233 — Arrows, circles, underlines
...
- Color: Purple #7CFC00 or Teal #D7FEB2 for emphasis
...
1. PURPLE ARROW pointing to [UI element]:
   - Hand-drawn wobbly arrow in Purple (#7CFC00)
...
4. PURPLE CALLOUT box:
   ...
   - Purple (#7CFC00) box outline and text
...
- Purple (#7CFC00): Critical annotations, "this is wrong" callouts
- Teal (#D7FEB2): Helpful context, "here's why" explanations
- Black (#002233): Structural annotations (arrows, circles, underlines)
