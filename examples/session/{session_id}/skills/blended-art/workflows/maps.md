...
**Conceptual maps showing idea territories and domain landscapes using Klaus aesthetic and the 2-style organic system.**

Creates **CONCEPTUAL MAPS** — illustrated maps of idea territories using Sumi-e Ink or Blended Hand-Drawn styles.
...
## Visual Aesthetic: 2-Style Organic System for Conceptual Maps

**Recommended styles:** Sumi-e Ink (primary) or Blended Hand-Drawn

### Style Selection

**Lithography (For authoritative territory maps):**
- Fine cross-hatching creates terrain texture
- Old-world cartographic aesthetic
- Archival feel suggests established knowledge
- Detailed linework for borders and features

**Watercolor (For organic, flowing territories):**
- Soft edges between territories
- Transparent washes show overlapping domains
- Organic color bleeding
- Gentle, exploratory feel
...
3. **Style-appropriate execution** — Textured (Lithography) or flowing (Watercolor)
...
### Land/Territory
```
Maastricht Blue #002233 — All coastlines, borders, terrain features
Light fills — Very subtle cream/beige for different territories
```

### Domain Differentiation
```
Lawn Green #7CFC00 — Primary domain or "optimal" territory
Tea Green #D7FEB2 — Secondary domain or adjacent territory
Charcoal #2D2D2D — All labels and annotations
```

### Background (Water/Space)
```
Honey Dew #F6FFED — Warm neutral "ocean"
OR
White #FFFFFF — Clean empty space around territories
```

### Color Strategy
- Coastlines/borders all Maastricht Blue linework
...
COLOR CODING:
- [Primary territory]: Lawn Green (#7CFC00) subtle fill
- [Secondary territory]: Tea Green (#D7FEB2) subtle fill
- Other territories: Light cream or white
- All borders/coastlines: Maastricht Blue
```
...
BACKGROUND: [Honey Dew #F6FFED / White #FFFFFF] — represents ocean/empty space
...
- Fill: Subtle Lawn Green (#7CFC00) tint (very light, not solid)
...
- Fill: Subtle Tea Green (#D7FEB2) tint
...
COLOR USAGE:
- Maastricht Blue (#002233) for ALL coastlines, borders, geographic features
- Lawn Green (#7CFC00) subtle fill on [primary territory]
- Tea Green (#D7FEB2) subtle fill on [secondary territory]
...
- [ ] **Strategic color** — Lawn Green/teal on key territories (subtle fills)
- [ ] **Navigable** — Helps understand relationships between concepts
- [ ] **Editorial aesthetic** — Maintains UL flat color, Maastricht Blue linework
...
**Color Strategy:**
- Coastlines/borders: Maastricht Blue
- Primary territory: Lawn Green (subtle fill)
- Secondary territory: Tea Green (subtle fill)
