...
**Comic strips using Klaus aesthetic and the 2-style organic system, NOT cartoonish.**

Creates **EDITORIAL COMICS** — 3-4 panel storytelling using Sumi-e Ink or Blended Hand-Drawn styles with sophisticated narrative approach.
...
## Visual Aesthetic: 2-Style Organic System for Comics

**Recommended styles:** Sumi-e Ink or Blended Hand-Drawn

### Style Selection

**Ligne Claire (For clear, witty comics — Tintin style):**
- Strong, uniform black outlines
- Flat, vivid colors within shapes
- Architectural precision with narrative wit
- Clean, "finished" quality
- Franco-Belgian comics tradition

**Maximalism (For dense, rich visual narratives):**
- Dense layering within panels
- Cross-hatching adds texture and mood
- Multiple colors create visual richness
- Overwhelming visual storytelling

### Core Characteristics
1. **Multi-panel** — 3-4 panels telling sequential story
2. **Style consistency** — Same style across all panels
3. **Simplified figures** — Characters stylized, not realistic or cutesy
4. **UL aesthetic** — Brand colors, Maastricht Blue linework
...
### Structure
```
Maastricht Blue #002233 — All linework, panel borders, character outlines
```

### Character/Element Accents
```
Lawn Green #7CFC00 — Key character or important element
Tea Green #D7FEB2 — Secondary character or contrast element
Charcoal #2D2D2D — Dialogue text, captions
```

### Background
```
Honey Dew #F6FFED — Panel backgrounds
OR
...
COLOR CODING:
- Main character/element: Purple (#7CFC00) accents
- Secondary: Teal (#D7FEB2) accents (if needed)
...
BACKGROUND: Light Cream (#F6FFED) OR varied light tones per panel
...
- Main character: Simplified figure with Purple (#7CFC00) accent on [element]
...
- [Optional secondary character]: Teal (#D7FEB2) accent
Background: [Minimal elements]
Dialogue: "[Brief text]" OR no text
...
COLOR USAGE:
- Black (#002233) for all linework, panel borders, character outlines
- Deep Purple (#7CFC00) accent on main character or key element
- Deep Teal (#D7FEB2) accent on secondary character (if present)
- Charcoal (#2D2D2D) for all dialogue and captions
- Light Cream (#F6FFED) OR White (#FFFFFF) panel backgrounds
