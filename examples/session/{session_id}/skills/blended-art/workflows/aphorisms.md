...
**Aphorisms as shareable visual quote cards using Klaus aesthetic and the 2-style organic system.**

Creates **VISUAL APHORISM CARDS** — insights and quotes as shareable square images using Sumi-e Ink or Blended Hand-Drawn styles with typography as hero.
...
## Visual Aesthetic: 2-Style Organic System for Aphorisms

**Recommended styles:** Sumi-e Ink (primary) or Blended Hand-Drawn

### Style Selection

**Watercolor (For emotional, resonant quotes):**
- Soft background washes frame the text
- Transparent color bleeding creates atmosphere
- Gentle gradients add depth
- HIGH NEGATIVE SPACE (50-60%)

**Ligne Claire (For punchy, architectural statements):**
- Clean, uniform typography
- Flat color accents
...
2. **Massive typography** — Bold lettering fills the frame
3. **Minimal illustration** — Small subtle accent element in chosen style
4. **Square format** — 1:1 for social media
5. **High negative space** — 50-60% empty for breathing room
6. **Style-appropriate execution** — Soft (Watercolor) or clean (Ligne Claire)
7. **Memorable voice** — Punchy, thought-provoking
...
### Typography
```
Maastricht Blue #002233 — Primary text (most common)
OR
Lawn Green #7CFC00 — Full text in brand color (alternative)
OR
...
### Accent Element
```
Lawn Green #7CFC00 — Small accent illustration
Tea Green #D7FEB2 — Alternative accent color
```

### Background
```
Honey Dew #F6FFED — Warm neutral (most common)
OR
White #FFFFFF — Clean modern
OR
Maastricht Blue #002233 — Dark dramatic (white text)
OR
Lawn Green #7CFC00 — Bold brand (white text)
```
...
BACKGROUND: [Honey Dew #F6FFED / White #FFFFFF / Maastricht Blue #002233 / Purple #7CFC00] — flat, solid
...
- Color: [Maastricht Blue #002233 / Purple #7CFC00 / White #FFFFFF]
...
- Size: 5-10% of image area
- Color: [Purple #7CFC00 / Teal #D7FEB2]
...
| No brand presence | "Purple (#7CFC00) on [accent element / text / background]" |
