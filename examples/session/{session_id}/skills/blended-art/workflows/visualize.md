...
**Intelligent multi-modal visualization combining optimal approaches based on content analysis and the Klaus 2-style organic system.**

Creates **ADAPTIVE VISUALIZATIONS** — analyzes content to select Klaus organic style (Sumi-e Ink or Blended Hand-Drawn) and orchestrate the best combination of visualization techniques, from pure data viz to mixed-media infographics to multi-panel compositions.

---

## Purpose

The Visualize workflow is the **intelligent visualization orchestrator**. Unlike the 13 specialized workflows (which each serve specific purposes), Visualize analyzes your content and chooses the optimal visualization strategy — which may be one approach, or a sophisticated combination of multiple techniques.
...
#### D. Color Strategy
Maintain Klaus aesthetic while supporting information hierarchy:
- **Black #000000:** Primary structure (chart axes, borders, main elements, linework)
- **Crab Red #D04040:** Critical insights, key data points, optimal zones (hanko seal accent)
- **Gold Leaf #D4AF37:** Secondary data, premium decorative elements
- **Black #000000:** All body text and labels
- **Background:** Klaus Off-White #F0EAD6 (washi paper feel) or white #FFFFFF

Strategic color use:
- Don't color everything
- Crab Red for "look here" moments (hanko seal style)
- Gold Leaf for premium/supporting information
...
COLOR CODING:
Crab Red: [Specific elements to highlight - hanko seal accent]
Gold Leaf: [Premium/supporting elements]
Black: [Structural elements, linework]
Text: All black
...
BACKGROUND: [Klaus Off-White #F0EAD6 / White #FFFFFF] — washi paper feel, flat, clean
...
TIER 1 - MAIN TITLE (Sorts Mill Goudy Display):
- "[TITLE TEXT]"
- Font: Sorts Mill Goudy style, extra bold, elegant serif, all-caps
...
TIER 2 - ELEMENT LABELS (Quattrocento Sans):
- [List all labels: chart axes, data labels, section headers]
- Font: Quattrocento Sans, clean, modern
- Size: Medium readable
- Color: Black #000000
- Positions: [Specify for each]

TIER 3 - ANNOTATIONS (Oranienbaum Italic):
- [List all annotations and insights]
- Font: Oranienbaum italic (Klaus voice)
- Size: Small (60% of Tier 2)
- Color: Crab Red #D04040 (insights) or Gold Leaf #D4AF37 (technical notes)
...
- Color: Black structure, Crab Red highlights on [specific], Gold Leaf on [specific]
...
- Color: Black linework, Crab Red accents on [specific]
- Integration: [How it relates to other elements]

[Continue for all elements...]

COLOR USAGE (Strategic, not overwhelming):
- Black (#000000): [All primary structure, chart elements, borders, linework]
- Crab Red (#D04040): [Critical data points, key insights, optimal zones - hanko seal accent]
- Gold Leaf (#D4AF37): [Secondary data, premium supporting elements]
- Black (#000000): [All text labels and annotations]
- Background: [Klaus Off-White #F0EAD6 or White]
...
- [ ] **Klaus aesthetic maintained:** Flat colors, organic Sumi-e or Blended Hand-Drawn aesthetic, felt experience or visible process
- [ ] **Typography hierarchy clear:** 3 tiers obviously distinct
- [ ] **Color strategic:** Crab Red/Gold Leaf highlight key elements, not overwhelming (hanko seal accent)
- [ ] **Composition balanced:** Visual weight distributed appropriately with intentional negative space (ma 間)
...
|---------|-----------|-----|
| **Too cluttered** | Too many elements competing | Simplify: reduce to 2-3 main elements, increase negative space (ma 間) |
| **Message unclear** | No clear visual hierarchy | Strengthen primary element (make larger, add Crab Red), reduce secondary |
...
| **Looks generic** | Missing Klaus aesthetic | Add hand-drawn editorial elements, strategic Crab Red/Gold Leaf, flatten any gradients |
| **Elements disconnected** | Poor composition | Redesign spatial layout, add visual connectors (arrows, borders, grouping) |
| **Color chaos** | Too much color everywhere | Limit Crab Red to 2-3 key elements, Gold Leaf to 1-2 supporting, rest black |
...
4. **Color discipline** — Crab Red/Gold Leaf strategic, not everywhere (hanko seal accent)
5. **Professional quality** — Deliverable to clients/publications
6. **Validate thoroughly** — Information + design + technical + audience
7. **Klaus aesthetic** — Organic Sumi-e or Blended Hand-Drawn, intentional negative space (ma 間)
