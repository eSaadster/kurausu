...
**Side-by-side visual comparisons using Klaus aesthetic and the 3-style system.**

Creates **VISUAL COMPARISONS** — "X vs Y" split compositions, before/after transformations using Sumi-e Ink, Japanese Precision, or Textural Neobrutalism styles.
...
## Visual Aesthetic: 4-Style System for Comparisons

**Recommended styles:** Maximalism (primary) or Ligne Claire

### Style Selection

**Maximalism (For rich, dense comparisons):**
- Dense layering on each side
- Contrasting visual elements show stark difference
- Cross-hatching adds texture
- Visual chaos organized into two halves

**Ligne Claire (For clear, accessible comparisons):**
- Clean outlines on both sides
- Flat colors differentiate the two approaches
- Architectural precision shows structural difference
...
3. **Style-appropriate execution** — Dense (Maximalism) or clean (Ligne Claire)
4. **Color differentiation** — Lawn Green for one side, Tea Green for other
5. **Immediate contrast** — Differences obvious at a glance
6. **UL aesthetic** — Brand colors, Maastricht Blue linework
...
```
Left/Top Side: Lawn Green #7CFC00 accents
Right/Bottom Side: Tea Green #D7FEB2 accents
OR
Both sides: Maastricht Blue with strategic purple/teal highlights
```

### Structure
```
Maastricht Blue #002233 — Dividing line, all linework on both sides
Charcoal #2D2D2D — All text and labels
```

### Background
```
White #FFFFFF or Honey Dew #F6FFED on both sides
OR
Left: Light Lawn Green tint, Right: Light Tea Green tint (very subtle)
```

### Color Strategy
- Option 1: Lawn Green accents left, Tea Green accents right (clear differentiation)
- Option 2: Both Maastricht Blue linework, purple on "preferred" side
...
COLOR STRATEGY:
- [Lawn Green left / Tea Green right] OR [Lawn Green on preferred, black on alternative]
```
...
- Color: [Lawn Green accents / Maastricht Blue only]

Right/Bottom: [Side B]
- Metaphor: [Contrasting illustration]
- Key elements: [Specific visual details]
- Color: [Tea Green accents / Maastricht Blue only]
...
BACKGROUND: [White #FFFFFF OR Honey Dew #F6FFED] — clean, flat, both sides

AESTHETIC:
- Split composition with [vertical/horizontal] division
- Hand-drawn Maastricht Blue linework on both sides (imperfect, gestural)
...
- [Maastricht Blue dividing line] OR [Visual separation through composition]
...
- Size: 60% of Tier 2
- Color: Matches side color (Lawn Green left, Tea Green right)
...
- Color: Lawn Green (#7CFC00) accents on [specific elements]
- Maastricht Blue (#002233) primary linework
...
- Color: Tea Green (#D7FEB2) accents on [specific elements]
- Maastricht Blue (#002233) primary linework
- Represents: [What this side embodies]

[OR if one side is preferred:]
- Preferred side: Lawn Green (#7CFC00) accents
- Alternative side: Maastricht Blue only (or subtle Tea Green)
...
COLOR USAGE:
- Maastricht Blue (#002233) for all linework on both sides and dividing line
- Left side: Lawn Green (#7CFC00) accents on [elements]
- Right side: Tea Green (#D7FEB2) accents on [elements]
- Charcoal (#2D2D2D) for all label text
- OR: Lawn Green on preferred side only, black on alternative
...
- [ ] **Color differentiation** — Lawn Green/teal (or purple/black) distinguishes sides
...
| Colors confusing | "Lawn Green accents left side only, Tea Green accents right side only" |
...
- **Color:** Lawn Green left, Tea Green right
- **Aspect:** 16:9
...
- **Color:** Lawn Green on "After" (preferred state)
- **Aspect:** 9:16
...
- **Color:** Lawn Green right (effective), black left (ineffective)
- **Aspect:** 16:9
...
**Color Strategy:**
- Balanced comparison: Lawn Green left, Tea Green right
- Value judgment: Lawn Green on better side, black on other
