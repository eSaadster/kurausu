...
**Comic strips using Klaus aesthetic and the 3-style system, NOT cartoonish.**

Creates **EDITORIAL COMICS** — 3-4 panel storytelling using Japanese Precision or Textural Neobrutalism styles with sophisticated narrative approach.
...
## Visual Aesthetic: 4-Style System for Comics

**Recommended styles:** Ligne Claire (primary) or Maximalism
