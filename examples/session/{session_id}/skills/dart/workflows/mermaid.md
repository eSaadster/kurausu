# Mermaid-Style Technical Diagrams

**Technical diagrams combining Mermaid structure with the Klaus 3-style system and Klaus color scheme.**

Creates **MERMAID DIAGRAMS** — flowcharts, sequence diagrams, state machines, and other technical diagrams using Japanese Precision or Textural Neobrutalism styles, derived from content via story explanation.
...
## Style Selection for Mermaid Diagrams

**Recommended styles:** Ligne Claire (primary) or Lithography (for complex/historical topics)

### Style Characteristics

**Ligne Claire (Recommended for most diagrams):**
- Strong, uniform black outlines
- Flat, vivid colors within shapes
- Clean, architectural precision
- Clear, finished quality
- NO gradients — flat colors only

**Lithography (For complex/gravitas topics):**
- Fine linework with cross-hatching for texture
- Old-world, archival feel
- Limited color palette
- Tonal depth through line density

### What This Looks Like
- Clean boxes with consistent line weight (Ligne Claire)
- Or textured boxes with cross-hatching (Lithography)
- Clear directional arrows
- Readable labels with good spacing
- Well-organized visual hierarchy

### AVOID
- Generic digital illustration aesthetic
- "AI slop" (too perfect, too shiny)
- Style inconsistency within diagram
- Gradients in Ligne Claire style
...
### Flow Emphasis
```
Crab Red #D04040 — Critical path, main flow, important states
Gold Leaf #D4AF37 — Alternative paths, secondary flows, supporting states
Black #000000 — All text labels and annotations
```

### Background
```
Klaus Off-White #F0EAD6 — Whiteboard/sketch paper feel
OR
...
**Flowcharts:**
- Main path boxes: Lawn Green outlines
- Alternative branches: Tea Green outlines
- Decision diamonds: Maastricht Blue outlines
- All connecting arrows: Maastricht Blue

**Sequence Diagrams:**
- Critical actor/entity: Lawn Green box
- Secondary actors: Tea Green boxes
- All messages/arrows: Maastricht Blue
- Activation boxes: Lawn Green fills (subtle)

**State Diagrams:**
- Active/important states: Lawn Green
- Transition states: Tea Green
- Terminal states: Maastricht Blue
- Arrows: Maastricht Blue with labels

**Class/ER Diagrams:**
- Key entities: Lawn Green boxes
- Related entities: Tea Green boxes
- Relationships: Maastricht Blue arrows with labels
- Inheritance: Maastricht Blue with different arrow style
...
NODES:
- Start: [Label]
- Process 1: [Action description] (rectangle, Crab Red)
- Decision 1: [Question] (diamond, black)
- Process 2a: [Action if yes] (rectangle, Crab Red)
- Process 2b: [Action if no] (rectangle, Gold Leaf)
...
(This path highlighted with Crab Red boxes)
```
...
#### C. Visual Hierarchy
- **Primary path/flow:** Lawn Green boxes, thicker lines
- **Secondary paths:** Tea Green boxes, standard lines
- **Structure/framework:** Maastricht Blue lines and shapes
...
**Build the generation prompt with Excalidraw + Mermaid + Klaus aesthetic:**
...
BACKGROUND: [Klaus Off-White #F0EAD6 / White #FFFFFF] — whiteboard/sketch paper feel
...
- Critical path highlighted in Crab Red
- Alternative paths in Gold Leaf
...
- Color: Maastricht Blue (#002233) outline, no fill OR subtle cream fill
- Size: [Relative size]
...
- Color: Lawn Green (#7CFC00) outline — CRITICAL PATH
...
- Color: Maastricht Blue (#002233) outline
...
- Color: Tea Green (#D7FEB2) outline — SECONDARY PATH
- Fill: Light cream or transparent
- Size: [Relative size]
...
- Activation boxes: Rectangles on lifelines (Crab Red for key)
...
- Maastricht Blue (#002233): All primary structure (most boxes, all arrows)
- Lawn Green (#7CFC00): Critical path nodes, main flow, key entities (10-20% of nodes)
- Tea Green (#D7FEB2): Alternative paths, secondary entities (5-10% of nodes)
- Charcoal (#2D2D2D): All text labels (node labels, arrow labels)
- Background: Honey Dew (#F6FFED) OR White (#FFFFFF)

CRITICAL REQUIREMENTS:
- Excalidraw hand-drawn aesthetic (wobbly, sketchy, organic)
- Mermaid diagram structure ([chosen type] grammar)
- Klaus color scheme (Crab Red for critical, Gold Leaf for secondary, black structure)
...
- Is the critical path obvious (Crab Red highlights)?
- Are labels readable despite hand-lettered style?
- Does it maintain Klaus aesthetic (flat colors, no gradients)?
...
#### UL Editorial Style
- [ ] **Color strategic:** Lawn Green on critical (10-20%), Gold Leaf on secondary (5-10%)
- [ ] **Maastricht Blue dominant:** Most structure in black
...
- [ ] **Critical path clear:** Lawn Green highlights guide eye
...
| **Can't follow flow** | Unclear structure | Strengthen arrow directions, add labels, clarify critical path with Crab Red |
...
| **Color overload** | Too much Crab Red/Gold Leaf | Limit: "Lawn Green on 2-3 critical nodes only, Gold Leaf on 1-2 secondary, rest black" |
| **Looks generic** | Missing UL or Excalidraw style | Combine both: "Excalidraw wobbly whiteboard sketch + UL Crab Red/Gold Leaf strategic accents" |
...
**Color Strategy:**
- Lawn Green: Main success/happy path
- Tea Green: Error handling or alternative paths
- Maastricht Blue: All decision nodes and structure
...
**Color Strategy:**
- Lawn Green: Critical actor/main entity
- Tea Green: Secondary actors
- Maastricht Blue: All messages/arrows
- Lawn Green fill: Activation bars for critical entity
...
**Color Strategy:**
- Lawn Green: Active/current/important states
- Tea Green: Intermediate states
- Maastricht Blue: Terminal and error states
- All transitions: Maastricht Blue arrows
...
**Color Strategy:**
- Lawn Green: Core/important entities
- Tea Green: Related entities
- Maastricht Blue: All relationship lines
...
**Structure:** Start → Enter Credentials → Valid? → [Yes] → Generate Token → Success
                                                   → [No] → Retry Limit? → [Yes] → Lock Account
                                                                         → [No] → Return to Enter
**Color:** Lawn Green on success path, Tea Green on error handling
...
**Color:** Lawn Green on Gateway (critical), Tea Green on Auth (secondary)
...
**Structure:** Initial → Pending → Processing → Shipped → Delivered → Final
                               → (error) → Cancelled
**Color:** Lawn Green on happy path states, Tea Green on processing, Maastricht Blue on cancelled
**Aspect:** 1:1 square
...
**Color:** Lawn Green on User and Post (core), Tea Green on Comment and Category
**Aspect:** 16:9 horizontal
...
4. **Klaus color scheme:** Strategic Crab Red/Gold Leaf, black structure
...
**The synthesis: Mermaid structure + Ligne Claire/Lithography style + Klaus colors = Technical diagrams that are clear, professional, and visually distinctive.**
