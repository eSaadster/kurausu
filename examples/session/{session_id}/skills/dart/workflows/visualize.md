...
**Intelligent multi-modal visualization combining optimal approaches based on content analysis and the Klaus 3-style system.**

Creates **ADAPTIVE VISUALIZATIONS** — analyzes content to select Klaus style (Sumi-e Ink, Japanese Precision, or Textural Neobrutalism) and orchestrate the best combination of visualization techniques, from pure data viz to mixed-media infographics to multi-panel compositions.
...
- [ ] **Klaus aesthetic maintained:** Flat colors, Japanese minimalism + neobrutalism, appropriate hand-drawn vs precise
...
7. **Klaus aesthetic** — Japanese minimalism + Neobrutalism, intentional negative space (ma 間)
