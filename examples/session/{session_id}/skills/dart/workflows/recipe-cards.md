...
**Step-by-step visual recipes for processes and methodologies using Klaus aesthetic and the 3-style system.**

Creates **PROCESS RECIPE CARDS** — numbered steps with small illustrations using Japanese Precision or Textural Neobrutalism styles.
...
## Visual Aesthetic: 4-Style System for Recipe Cards

**Recommended styles:** Ligne Claire (primary) or Lithography

### Style Selection

**Ligne Claire (For clear, approachable recipes):**
- Clean icons with uniform outlines
- Flat colors make steps scannable
- Architectural precision shows process flow
- Professional, deliverable quality

**Lithography (For authoritative methodologies):**
- Detailed icons with cross-hatching
- Archival feel suggests proven process
- Fine linework adds gravitas
- Limited palette maintains focus

### Core Characteristics
1. **Numbered steps** — Clear 1, 2, 3 progression
2. **Small illustration per step** — Icon in chosen style for each action
3. **Scannable format** — Easy to reference and follow
4. **Recipe card layout** — Compact, organized, referenceable
5. **Style-consistent icons** — All icons match chosen style
...
### Structure
```
Maastricht Blue #002233 — Step numbers, dividing lines, icon outlines
```

### Step Differentiation
```
Lawn Green #7CFC00 — Critical steps or outcomes
Tea Green #D7FEB2 — Supporting steps or inputs
Charcoal #2D2D2D — All body text and descriptions
```

### Background
```
Honey Dew #F6FFED — Recipe card warmth
OR
...
BACKGROUND: [Honey Dew #F6FFED OR White #FFFFFF] — clean, card-like
...
- All arrows in Black (#002233) except critical path (Purple)

COLOR USAGE:
- Black (#002233) for most step badges, icons, arrows
- Deep Purple (#7CFC00) for critical step(s) and final outcome
- Deep Teal (#D7FEB2) optional for input/supporting steps
...
| Missing emphasis | "Purple (#7CFC00) on Step [X] critical and final outcome step" |
